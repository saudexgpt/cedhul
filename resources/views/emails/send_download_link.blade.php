                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{ url('images/logo.jpg') }}" alt="Logo"
                                      title="Logo"
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-font-size"
                                ...
                                <strong>Your download link<br /></strong>
                              </h1>
                              ...
                              <div style="color: #4b4a4a; line-height: 190%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 18px; line-height: 34.2px;"><strong><span
                                        ...
                                        {{ $download->full_name }},</span></strong></span></p>
                                <p style="font-size: 14px; line-height: 190%;"><span
                                    style="font-size: 16px; line-height: 30.4px;">Click the link below OR copy and
                                    paste it in your browser to download your
                                    document:
                                    <br /></span></p>
                                <p>
                                  <span>
                                    <div>
                                      <a href="{{ $download->link }}" target="_blank">{{ $download->link }}</a>
                                    </div>
                                  </span>
                                </p>
                              </div>
